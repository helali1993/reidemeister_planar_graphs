...
class SignedPlanarGraph:
    ...
    def create_nodes_from_faces(self, graph):
        ...
        [black, white] = SignedPlanarGraph.shade_faces_new(outer_regions, faces, outer_face)
        ...
        '''
        should replace with defined class method
        find_loops_in_medial
        '''
        self.black_loops = []
    ...
    @staticmethod
    def shade_faces_new(outer_reigons, faces_list, outer_face):
    ...
    def draw_sp_graph_sign(self, path=None):
            if path:
                ...
                path_final = "pyknotid_helali/my_code_1/images/medial_graph_black_sol_" + str(SignedPlanarGraph.drawing_number) + ".png"
                A.draw( path_final, prog='dot')
                SignedPlanarGraph.drawing_number += 1
                ...
                A = to_agraph(joker_graph)
                path_final = "pyknotid_helali/my_code_1/images/medial_graph_white_sol_" + str(SignedPlanarGraph.drawing_number) + ".png"
                A.draw( path_final, prog='dot')
                SignedPlanarGraph.drawing_number += 1
    ...
    def find_cycles_of_length(graph, desired_length):
        ...
        cycles = nx.cycle_basis(no_multi_graph)  # or nx.simple_cycles(G)
