...
class ReidemeisterMoves:
    ...
    def reidemeister_I_helper(sp_graph: SignedPlanarGraph) -> SignedPlanarGraph:
        ...
        if sp_graph.white_loops != None:
            [crossing, ch_r_i] = ReidemeisterMoves.reidemeister_helper_I_black(sp_graph)
            if ch_r_i:
                '''
        ...
        if sp_graph.black_loops != None:
            [crossing, ch_r_i] = ReidemeisterMoves.reidemeister_I_helper_white(sp_graph)
            if ch_r_i:
                '''
                We have found an RI pair!!!
                Cleaning up
    ...
    def reidemeister_helper_I_black(sp_graph):
    ...
    def reidemeister_helper_I_white(sp_graph):
